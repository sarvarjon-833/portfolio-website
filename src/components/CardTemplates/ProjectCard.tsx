  ...
  return (
    <>
      <Card className="bg-zinc-900/50 flex flex-col border border-zinc-800 text-white rounded-2xl hover:border-zinc-700 transition-all duration-300 w-full overflow-hidden">
        ...
        <CardFooter className="flex items-center gap-3 pt-4 border-t  bg-zinc-800 border-zinc-800">
          <a
            href={codeLink}
            className="flex items-center gap-2 px-4 py-2 bg-transparent border border-zinc-700 text-zinc-300 rounded-lg text-sm font-medium hover:bg-zinc-800 hover:text-emerald-400 hover:border-zinc-600 transition-all duration-300"
          >
            <svg
